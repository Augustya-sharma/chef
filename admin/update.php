...
//Check For An Update
$getVersions = file_get_contents('https://bylancer.com/api/quickqr-release-versions.php') or die ('ERROR');
if ($getVersions != '')
{
        ...
        if ( $aV > $config['version']) {
            ...
            if ( !is_file(  $update_dir.'QUICKQR-CMS-'.$aV.'.zip' )) {
                ...
                <form id="upload" method="post" action="upload.php" enctype="multipart/form-data">
                    <div id="drop">
                        Drop Here <br>QUICKQR-CMS-<?php echo $aV ?>.zip
                        <a>Browse</a>
            ...
            if (isset($_GET['doUpdate']) && $_GET['doUpdate'] == true) {
                ...
                $content .= "\$config['db']['port'] = '" . $config['db']['port'] . "';\n";
                $content .= "\n";
